...
import { EmailHeaders, Message, MessageListOptions, MessageUpdateParams, Report, SpamReport } from "../../../../src/types/api/messages";
export default class MessagesApi {
     ...
     */
    get(inboxId: number, options?: MessageListOptions): Promise<Message[]>;
    /**
